import { ButtonStack, IconButton, IconButtonMenu, Spacer } from "cedro/src/ui";
import { Widget, WidgetAlignTypes, WidgetTypes } from "cedro/src/ui";
...
class Header extends Widget {
    ...
    constructor(id: string, parent: Widget | null = null) {
        ...
        this.theme.subscribe({
            event: "click",
            then: (_e, _w) => {
                const theme = app.theme.getTheme();
